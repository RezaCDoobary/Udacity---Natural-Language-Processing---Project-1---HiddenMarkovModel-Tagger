# Udacity - Natural Language Processing - Project 1

This repo is my submission to the natural language processing udacity nanodegree. The remaining parts of the readme are exactly as in the original exercise.
